 ...
 *
 * See also TEST_KICAD_APP
 */
class TEST_WXAPP_BASE : public wxApp
{
public:
    TEST_WXAPP_BASE()
    {
...
/**
 * This is base wxApp, which contains initialisation specific for KiCad (i.e. PGM_BASE, KiWay
 * and so on. This boilerplate code is kept in OnInit() and OnExit(), so derived classes
 * are responsible for calling these functions properly.
 */
class TEST_KICAD_APP : public TEST_WXAPP_BASE
{
public:
    TEST_KICAD_APP() {}
    virtual ~TEST_KICAD_APP() {};
 ...
 *
 * Template parameter should be class derived from TEST_WXAPP_BASE.
 */
