...
#ifndef NS_NATIVE_KEY_TO_DOM_CODE_NAME_INDEX
#define NS_NATIVE_KEY_TO_DOM_CODE_NAME_INDEX( aNativeKey, aCodeIndexName )
#endif

#ifndef NS_WX_KEY_TO_DOM_CODE_NAME_INDEX
#define NS_WX_KEY_TO_DOM_CODE_NAME_INDEX( aWXKey, aCodeIndexName )
#endif
...
// wxWidgets WXK_
#define CODE_MAP_WX( aCPPCodeName, aWXKey )                                    \
    NS_WX_KEY_TO_DOM_CODE_NAME_INDEX( aWXKey, CODE_NAME_INDEX_##aCPPCodeName )
...
// IntlBackslash
CODE_MAP_WIN( Backslash, 0x0056 )
CODE_MAP_MAC( Backslash, kVK_ISO_Section )
CODE_MAP_X11( Backslash, 0x005E )
CODE_MAP_ANDROID( Backslash, 0x0056 )
CODE_MAP_WX( Backslash, '\\' )
...
CODE_MAP_WX( Backspace, WXK_BACK )
...
// IntlRo
CODE_MAP_WIN( Slash, 0x0073 )
CODE_MAP_MAC( Slash, kVK_JIS_Underscore )
CODE_MAP_X11( Slash, 0x0061 )
CODE_MAP_ANDROID( Slash, 0x0059 )
CODE_MAP_WX( Slash, '/' )
...
// AltRight
CODE_MAP_WIN( AltLeft, 0xE038 )
CODE_MAP_MAC( AltLeft, kVK_RightOption )
CODE_MAP_X11( AltLeft, 0x006C )
CODE_MAP_ANDROID( AltLeft, 0x0064 )
CODE_MAP_WX( AltLeft, WXK_ALT )
...
CODE_MAP_WX( CapsLock, WXK_CAPITAL )
...
CODE_MAP_WX( ContextMenu, WXK_WINDOWS_MENU )
...
// ControlRight
CODE_MAP_WIN( ControlLeft, 0xE01D )
CODE_MAP_MAC( ControlLeft, kVK_RightControl )
CODE_MAP_X11( ControlLeft, 0x0069 )
CODE_MAP_ANDROID( ControlLeft, 0x0061 )
CODE_MAP_WX( ControlLeft, WXK_CONTROL )
...
CODE_MAP_WX( MetaLeft, WXK_WINDOWS_LEFT )
...
CODE_MAP_WX( MetaRight, WXK_WINDOWS_RIGHT )
...
// ShiftRight
CODE_MAP_WIN( ShiftLeft, 0x0036 )
CODE_MAP_MAC( ShiftLeft, kVK_RightShift )
CODE_MAP_X11( ShiftLeft, 0x003E )
CODE_MAP_ANDROID( ShiftLeft, 0x0036 )
CODE_MAP_WX( ShiftLeft, WXK_SHIFT )
...
CODE_MAP_WX( ArrowDown, WXK_DOWN )
...
CODE_MAP_WX( ArrowLeft, WXK_LEFT )
...
CODE_MAP_WX( NumLock, WXK_NUMLOCK )
...
CODE_MAP_WX( Numpad0, WXK_NUMPAD0 )
...
CODE_MAP_WX( Numpad1, WXK_NUMPAD1 )
...
CODE_MAP_WX( Numpad2, WXK_NUMPAD2 )
...
CODE_MAP_WX( Numpad3, WXK_NUMPAD3 )
...
CODE_MAP_WX( Numpad4, WXK_NUMPAD4 )
...
CODE_MAP_WX( Numpad5, WXK_NUMPAD5 )
...
CODE_MAP_WX( Numpad6, WXK_NUMPAD6 )
...
CODE_MAP_WX( Numpad7, WXK_NUMPAD7 )
...
CODE_MAP_WX( Numpad8, WXK_NUMPAD8 )
...
CODE_MAP_WX( Numpad9, WXK_NUMPAD9 )
...
CODE_MAP_WX( NumpadAdd, WXK_NUMPAD_ADD )
...
CODE_MAP_WX( NumpadComma, WXK_NUMPAD_DELETE )
...
CODE_MAP_WX( NumpadDecimal, WXK_NUMPAD_DECIMAL )
...
CODE_MAP_WX( NumpadDivide, WXK_NUMPAD_DIVIDE )
...
CODE_MAP_WX( NumpadEnter, WXK_NUMPAD_ENTER )
...
CODE_MAP_WX( NumpadEqual, WXK_NUMPAD_EQUAL )
...
CODE_MAP_WX( NumpadMultiply, WXK_NUMPAD_MULTIPLY )
...
CODE_MAP_WX( NumpadSubtract, WXK_NUMPAD_SUBTRACT )
...
CODE_MAP_WX( VolumeDown, WXK_VOLUME_DOWN )
...
CODE_MAP_WX( VolumeMute, WXK_VOLUME_MUTE )
...
CODE_MAP_WX( VolumeUp, WXK_VOLUME_UP )
