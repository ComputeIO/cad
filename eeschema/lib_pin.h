...
public:
    ...
    DRAW_PIN_ORIENT GetOrientation() const { return m_orientation; }
    void            SetOrientation( DRAW_PIN_ORIENT aOrientation ) { m_orientation = aOrientation; }
     ...
     */
    DRAW_PIN_ORIENT PinDrawOrient( const TRANSFORM& aTransform ) const;
     ...
     */
    void PlotPinTexts( PLOTTER* aPlotter, const VECTOR2I& aPinPos, DRAW_PIN_ORIENT aPinOrient,
                       int aTextInside, bool aDrawPinNum, bool aDrawPinName ) const;

    void PlotSymbol( PLOTTER* aPlotter, const VECTOR2I& aPosition, DRAW_PIN_ORIENT aOrientation ) const;
...
protected:
     ...
     */
    void printPinSymbol( const RENDER_SETTINGS* aSettings, const VECTOR2I& aPos, DRAW_PIN_ORIENT aOrientation );
     ...
     */
    void printPinTexts( const RENDER_SETTINGS* aSettings, VECTOR2I& aPinPos, DRAW_PIN_ORIENT aPinOrient,
...
protected:
    ...
    DRAW_PIN_ORIENT         m_orientation;   // Pin orientation (Up, Down, Left, Right)
    GRAPHIC_PINSHAPE        m_shape;         // Shape drawn around pin
    ELECTRICAL_PINTYPE      m_type;          // Electrical type of the pin.
