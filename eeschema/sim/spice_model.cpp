...
TYPE_INFO SPICE_MODEL::TypeInfo( TYPE aType )
{
    ...
    case TYPE::R:                          return { DEVICE_TYPE::RESISTOR,   NGSPICE::MODEL_TYPE::NONE,      "",                "Ideal"                                                  };
    case TYPE::RESISTOR:                   return { DEVICE_TYPE::RESISTOR,   NGSPICE::MODEL_TYPE::RESISTOR,  "ADVANCED",        "Advanced"                                               };

    case TYPE::C:                          return { DEVICE_TYPE::CAPACITOR,  NGSPICE::MODEL_TYPE::NONE,      "",                "Ideal"                                                  };
    case TYPE::CAPACITOR:                  return { DEVICE_TYPE::CAPACITOR,  NGSPICE::MODEL_TYPE::CAPACITOR, "ADVANCED",        "Advanced"                                               };

    case TYPE::L:                          return { DEVICE_TYPE::INDUCTOR,   NGSPICE::MODEL_TYPE::NONE,      "",                "Ideal"                                                  };
    case TYPE::INDUCTOR:                   return { DEVICE_TYPE::INDUCTOR,   NGSPICE::MODEL_TYPE::INDUCTOR,  "LOSSLESS_COIL",   "Lossless coil"                                          };
    ...
    case TYPE::NPN_GUMMEL_POON:            return { DEVICE_TYPE::NPN,        NGSPICE::MODEL_TYPE::BJT,       "NPN_GUMMEL_POON", "Gummel-Poon"                                            };
    case TYPE::PNP_GUMMEL_POON:            return { DEVICE_TYPE::PNP,        NGSPICE::MODEL_TYPE::BJT,       "PNP_GUMMEL_POON", "Gummel-Poon"                                            };
    case TYPE::NPN_VBIC:                   return { DEVICE_TYPE::NPN,        NGSPICE::MODEL_TYPE::VBIC,      "NPN_VBIC",        "VBIC"                                                   };
    case TYPE::PNP_VBIC:                   return { DEVICE_TYPE::PNP,        NGSPICE::MODEL_TYPE::VBIC,      "PNP_VBIC",        "VBIC"                                                   };
    //case TYPE::BJT_MEXTRAM:             return { DEVICE_TYPE::BJT,        "Q", 6,  "MEXTRAM",         "MEXTRAM" };
    case TYPE::NPN_HICUM_L2:               return { DEVICE_TYPE::NPN,        NGSPICE::MODEL_TYPE::HICUM2,    "NPN_HICUM_L2",    "HICUM Level 2"                                          };
    case TYPE::PNP_HICUM_L2:               return { DEVICE_TYPE::PNP,        NGSPICE::MODEL_TYPE::HICUM2,    "PNP_HICUM_L2",    "HICUM Level 2"                                          };
    ...
    case TYPE::NMES_STATZ:                 return { DEVICE_TYPE::NMES,       NGSPICE::MODEL_TYPE::MES,       "NMES_STATZ",      "Statz"                                                  };
    case TYPE::PMES_STATZ:                 return { DEVICE_TYPE::PMES,       NGSPICE::MODEL_TYPE::MES,       "PMES_STATZ",      "Statz"                                                  };
    case TYPE::NMES_YTTERDAL:              return { DEVICE_TYPE::NMES,       NGSPICE::MODEL_TYPE::MESA,      "NMES_YTTERDAL",   "Ytterdal"                                               };
    case TYPE::PMES_YTTERDAL:              return { DEVICE_TYPE::PMES,       NGSPICE::MODEL_TYPE::MESA,      "PMES_YTTERDAL",   "Ytterdal"                                               };
    case TYPE::NMES_HFET1:                 return { DEVICE_TYPE::NMES,       NGSPICE::MODEL_TYPE::HFET1,     "NMES_HFET1",      "HFET1"                                                  };
    case TYPE::PMES_HFET1:                 return { DEVICE_TYPE::PMES,       NGSPICE::MODEL_TYPE::HFET1,     "PMES_HFET1",      "HFET1"                                                  };
    case TYPE::PMES_HFET2:                 return { DEVICE_TYPE::NMES,       NGSPICE::MODEL_TYPE::HFET2,     "NMES_HFET2",      "HFET2"                                                  };
    case TYPE::NMES_HFET2:                 return { DEVICE_TYPE::PMES,       NGSPICE::MODEL_TYPE::HFET2,     "PMES_HFET2",      "HFET2"                                                  };

    case TYPE::NMOS_MOS1:                  return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::MOS1,      "NMOS_MOS1",       "Classical quadratic (MOS1)"                             };
    case TYPE::PMOS_MOS1:                  return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::MOS1,      "PMOS_MOS1",       "Classical quadratic (MOS1)"                             };
    case TYPE::NMOS_MOS2:                  return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::MOS2,      "NMOS_MOS2",       "Grove-Frohman (MOS2)"                                   };
    case TYPE::PMOS_MOS2:                  return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::MOS2,      "PMOS_MOS2",       "Grove-Frohman (MOS2)"                                   };
    case TYPE::NMOS_MOS3:                  return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::MOS3,      "NMOS_MOS3",       "MOS3"                                                   };
    case TYPE::PMOS_MOS3:                  return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::MOS3,      "PMOS_MOS3",       "MOS3"                                                   };
    case TYPE::NMOS_BSIM1:                 return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::BSIM1,     "NMOS_BSIM1",      "BSIM1"                                                  };
    case TYPE::PMOS_BSIM1:                 return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::BSIM1,     "PMOS_BSIM1",      "BSIM1"                                                  };
    case TYPE::NMOS_BSIM2:                 return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::BSIM2,     "NMOS_BSIM2",      "BSIM2"                                                  };
    case TYPE::PMOS_BSIM2:                 return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::BSIM2,     "PMOS_BSIM2",      "BSIM2"                                                  };
    case TYPE::NMOS_MOS6:                  return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::MOS6,      "NMOS_MOS6",       "MOS6"                                                   };
    case TYPE::PMOS_MOS6:                  return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::MOS6,      "PMOS_MOS6",       "MOS6"                                                   };
    case TYPE::NMOS_BSIM3:                 return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::BSIM3,     "NMOS_BSIM3",      "BSIM3"                                                  };
    case TYPE::PMOS_BSIM3:                 return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::BSIM3,     "PMOS_BSIM3",      "BSIM3"                                                  };
    case TYPE::NMOS_MOS9:                  return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::MOS9,      "NMOS_MOS9",       "MOS9"                                                   };
    case TYPE::PMOS_MOS9:                  return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::MOS9,      "PMOS_MOS9",       "MOS9"                                                   };
    case TYPE::NMOS_B4SOI:                 return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::B4SOI,     "NMOS_B4SOI",      "BSIM4 SOI (B4SOI)"                                      };
    case TYPE::PMOS_B4SOI:                 return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::B4SOI,     "PMOS_B4SOI",      "BSIM4 SOI (B4SOI)"                                      };
    case TYPE::NMOS_BSIM4:                 return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::BSIM4,     "NMOS_BSIM4",      "BSIM4"                                                  };
    case TYPE::PMOS_BSIM4:                 return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::BSIM4,     "PMOS_BSIM4",      "BSIM4"                                                  };
    ...
    case TYPE::NMOS_B3SOIFD:               return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::B3SOIFD,   "NMOS_B3SOIFD",    "B3SOIFD (BSIM3 fully depleted SOI)"                     };
    case TYPE::PMOS_B3SOIFD:               return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::B3SOIFD,   "PMOS_B3SOIFD",    "B3SOIFD (BSIM3 fully depleted SOI)"                     };
    case TYPE::NMOS_B3SOIDD:               return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::B3SOIDD,   "NMOS_B3SOIDD",    "B3SOIDD (BSIM3 SOI, both fully and partially depleted)" };
    case TYPE::PMOS_B3SOIDD:               return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::B3SOIDD,   "PMOS_B3SOIDD",    "B3SOIDD (BSIM3 SOI, both fully and partially depleted)" };
    case TYPE::NMOS_B3SOIPD:               return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::B3SOIPD,   "NMOS_B3SOIPD",    "B3SOIPD (BSIM3 partially depleted SOI)"                 };
    case TYPE::PMOS_B3SOIPD:               return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::B3SOIPD,   "PMOS_B3SOIPD",    "B3SOIPD (BSIM3 partially depleted SOI)"                 };
    //case TYPE::NMOS_STAG:             return { DEVICE_TYPE::NMOS,     "M", 60, "STAG",            "STAG" };
    //case TYPE::PMOS_STAG:             return { DEVICE_TYPE::PMOS,     "M", 60, "STAG",            "STAG" };
    case TYPE::NMOS_HISIM2:                return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::HISIM2,    "NMOS_HISIM2",     "HiSIM2"                                                 };
    case TYPE::PMOS_HISIM2:                return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::HISIM2,    "PMOS_HISIM2",     "HiSIM2"                                                 };
    case TYPE::NMOS_HISIM_HV1:             return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::HISIMHV1,  "NMOS_HISIM_HV1",  "HiSIM_HV1"                                              };
    case TYPE::PMOS_HISIM_HV1:             return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::HISIMHV1,  "PMOS_HISIM_HV1",  "HiSIM_HV1"                                              };
    case TYPE::NMOS_HISIM_HV2:             return { DEVICE_TYPE::NMOS,       NGSPICE::MODEL_TYPE::HISIMHV2,  "NMOS_HISIM_HV2",  "HiSIM_HV2"                                              };
    case TYPE::PMOS_HISIM_HV2:             return { DEVICE_TYPE::PMOS,       NGSPICE::MODEL_TYPE::HISIMHV2,  "PMOS_HISIM_HV2",  "HiSIM_HV2"                                              };

    case TYPE::VSOURCE_PULSE:              return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_PULSE",   "Pulse"                                                  };
    case TYPE::VSOURCE_SIN:                return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_SINCE",   "Sine"                                                   };
    case TYPE::VSOURCE_EXP:                return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_EXP",     "Exponential"                                            };
    case TYPE::VSOURCE_SFAM:               return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_SFAM",    "Single-frequency AM"                                    };
    case TYPE::VSOURCE_SFFM:               return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_SFFM",    "Single-frequency FM"                                    };
    case TYPE::VSOURCE_PWL:                return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_PWL",     "Piecewise linear"                                       };
    case TYPE::VSOURCE_NOISE:              return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_NOISE",   "Noise"                                                  };
    case TYPE::VSOURCE_RANDOM_UNIFORM:     return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_RANDOM_UNIFORM",  "Random uniform"                                         };
    case TYPE::VSOURCE_RANDOM_GAUSSIAN:    return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_RANDOM_GAUSSIAN",  "Random Gaussian"                                        };
    case TYPE::VSOURCE_RANDOM_EXPONENTIAL: return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_RANDOM_EXPONENTIAL",  "Random exponential"                                     };
    case TYPE::VSOURCE_RANDOM_POISSON:     return { DEVICE_TYPE::VSOURCE,    NGSPICE::MODEL_TYPE::NONE,      "VSOURCE_RANDOM_POISSON",  "Random Poisson"                                     };

    case TYPE::ISOURCE_PULSE:              return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_PULSE",   "Pulse"                                                  };
    case TYPE::ISOURCE_SIN:                return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_SINCE",   "Sine"                                                   };
    case TYPE::ISOURCE_EXP:                return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_EXP",     "Exponential"                                            };
    case TYPE::ISOURCE_SFAM:               return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_SFAM",    "Single-frequency AM"                                    };
    case TYPE::ISOURCE_SFFM:               return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_SFFM",    "Single-frequency FM"                                    };
    case TYPE::ISOURCE_PWL:                return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_PWL",     "Piecewise linear"                                       };
    case TYPE::ISOURCE_NOISE:              return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_NOISE",   "Noise"                                                  };
    case TYPE::ISOURCE_RANDOM_UNIFORM:     return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_RANDOM_UNIFORM",  "Random uniform"                                         };
    case TYPE::ISOURCE_RANDOM_GAUSSIAN:    return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_RANDOM_GAUSSIAN",  "Random Gaussian"                                        };
    case TYPE::ISOURCE_RANDOM_EXPONENTIAL: return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_RANDOM_EXPONENTIAL",  "Random exponential"                                     };
    case TYPE::ISOURCE_RANDOM_POISSON:     return { DEVICE_TYPE::ISOURCE,    NGSPICE::MODEL_TYPE::NONE,      "ISOURCE_RANDOM_POISSON",  "Random Poisson"                                     };
...
NGSPICE::MODEL_INFO SPICE_MODEL::TypeModelInfo( TYPE aType )
{
    ...
    else
    {
        ...
        case TYPE::C:
            ...
            paramInfo.category = NGSPICE::PARAM_CATEGORY::PRINCIPAL;
            paramInfo.defaultValueOfVariant1 = "";
            paramInfo.description = "Capacitance";
        ...
        case TYPE::L:
            ...
            paramInfo.category = NGSPICE::PARAM_CATEGORY::PRINCIPAL;
            paramInfo.defaultValueOfVariant1 = "";
            paramInfo.description = "Inductance";
