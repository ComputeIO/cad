...
public:
    ...
    { 
        ...
        case TYPE::RESISTOR_SEMICONDUCTOR:  return { DEVICE_TYPE::RESISTOR,   NGSPICE::MODEL_TYPE::RESISTOR,  "SEMICONDUCTOR",   "Semiconductor model"                                          };

        case TYPE::CAPACITOR_IDEAL:         return { DEVICE_TYPE::CAPACITOR,  NGSPICE::MODEL_TYPE::NONE,      "IDEAL",           "Ideal model"                                                  };
        case TYPE::CAPACITOR_SEMICONDUCTOR: return { DEVICE_TYPE::CAPACITOR,  NGSPICE::MODEL_TYPE::CAPACITOR, "SEMICONDUCTOR",   "Semiconductor model"                                          };
