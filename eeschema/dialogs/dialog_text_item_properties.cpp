...
DIALOG_TEXT_ITEM_PROPERTIES::~DIALOG_TEXT_ITEM_PROPERTIES()
{
...
bool DIALOG_TEXT_ITEM_PROPERTIES::TransferDataToWindow()
{
 ...
 */
void DIALOG_TEXT_ITEM_PROPERTIES::OnEnterKey( wxCommandEvent& aEvent )
{
...
void DIALOG_TEXT_ITEM_PROPERTIES::onScintillaCharAdded( wxStyledTextEvent& aEvent )
{
...
bool DIALOG_TEXT_ITEM_PROPERTIES::TransferDataFromWindow()
{
...
void DIALOG_TEXT_ITEM_PROPERTIES::OnFormattingHelp( wxHyperlinkEvent& aEvent )
{
