...
DIALOG_LABEL_EDITOR_BASE::DIALOG_LABEL_EDITOR_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	m_textEntrySizer = new wxFlexGridSizer( 6, 2, 1, 3 );
	...
	m_fontFaceLabel = new wxStaticText( this, wxID_ANY, _("Font:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_fontFaceLabel->Wrap( -1 );
	m_textEntrySizer->Add( m_fontFaceLabel, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxTOP, 5 );

	wxBoxSizer* bFontFaceSizer;
	bFontFaceSizer = new wxBoxSizer( wxHORIZONTAL );

	m_fontFace = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_fontFace->SetMinSize( wxSize( 360,-1 ) );

	bFontFaceSizer->Add( m_fontFace, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxEXPAND|wxTOP, 5 );


	bFontFaceSizer->Add( 0, 0, 1, wxEXPAND, 5 );

	m_fontChooserButton = new wxButton( this, wxID_ANY, _("Choose Font..."), wxDefaultPosition, wxDefaultSize, 0 );
	bFontFaceSizer->Add( m_fontChooserButton, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxTOP, 5 );


	m_textEntrySizer->Add( bFontFaceSizer, 1, wxEXPAND, 5 );
	...
	m_fontChooserButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_LABEL_EDITOR_BASE::onShowFontDialog ), NULL, this );
}
...
DIALOG_LABEL_EDITOR_BASE::~DIALOG_LABEL_EDITOR_BASE()
{
	...
	m_fontChooserButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_LABEL_EDITOR_BASE::onShowFontDialog ), NULL, this );
