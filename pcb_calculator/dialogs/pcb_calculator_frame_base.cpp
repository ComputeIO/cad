...
>>>>>>> dc0a68d9e9 (Revert "set annotation to " " for now to ensure position of Zcommon is correct")
=======
	m_staticTextZcommon = new wxStaticText( m_panelTransline, wxID_ANY, _("Zcommon = Zeven / 2"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER_HORIZONTAL );
>>>>>>> f2ded10197 (Replace pcb_calculator_frame_base.cpp autogenerated from wxformbuilder)
...
>>>>>>> ff333e5dd3 (Replace pcb_calculator_frame_base.cpp - missing message declaration)
=======
	fgSizerTranslResults->Add( m_left_message8, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxLEFT|wxRIGHT, 5 );
>>>>>>> 6964c88082 (Replace pcb_calculator_frame_base.cpp - update alignment)
