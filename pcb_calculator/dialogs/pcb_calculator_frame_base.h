...
class PCB_CALCULATOR_FRAME_BASE : public KIWAY_PLAYER
{
	...
	protected:
		...
		wxTextCtrl* m_ESeries_SimpleSolution;
		wxStaticText* m_ESeriesSimpleErr;
		wxTextCtrl* m_ESeriesSimpleError;
		wxStaticText* m_ESeriesSimplePercent;
		wxStaticText* m_ESeriesAltSolution;
		wxTextCtrl* m_ESeries_AltSolution;
		wxStaticText* m_ESeriesAltErr;
		wxTextCtrl* m_ESeriesAltError;
		wxStaticText* m_ESeriesAltPercent;
		wxStaticText* m_ESerieHelpText111;
