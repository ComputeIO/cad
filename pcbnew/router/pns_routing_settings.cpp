        ...
        NESTED_SETTINGS( "pns", pnsSchemaVersion, aParent, aPath )
{
    ...
    m_cornerMode = DIRECTION_45::CornerMode::MITERED_45;
    ...
    m_params.emplace_back( new PARAM_ENUM<DIRECTION_45::CornerMode>(
            "corner_mode", &m_cornerMode, DIRECTION_45::CornerMode::MITERED_45,
            DIRECTION_45::CornerMode::ROUNDED_90, DIRECTION_45::CornerMode::MITERED_45 ) );
