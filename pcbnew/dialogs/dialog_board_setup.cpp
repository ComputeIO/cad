        ...
        m_frame( aFrame )
{
    ...
    m_treebook->AddPage( new PAGED_DIALOG_NULL_PANEL( this ),  _( "Board Stackup" ) );
    ...
    m_treebook->AddPage( new PAGED_DIALOG_NULL_PANEL( this ),  _( "Defaults" ) );
    ...
    m_treebook->AddPage( new PAGED_DIALOG_NULL_PANEL( this ),  _( "Design Rules" ) );
    ...
    m_treebook->AddPage( new PAGED_DIALOG_NULL_PANEL( this ), _( "Project" ) );
