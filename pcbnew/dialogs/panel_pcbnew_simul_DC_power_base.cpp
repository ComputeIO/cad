...
PANEL_PCBNEW_SIMUL_DC_POWER_BASE::PANEL_PCBNEW_SIMUL_DC_POWER_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText3111 = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("Electrical"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText312 = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("Select a net"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_netComboBox = new wxComboBox( m_scrolledWindow2, wxID_ANY, wxT("Combo!"), wxDefaultPosition, wxDefaultSize, 0, NULL, 0 );
	bSizer2->Add( m_netComboBox, 0, wxALL, 5 );


	bSizer32->Add( bSizer2, 0, wxEXPAND, 5 );

	m_staticText1111 = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("NOTE : Unit is V for sources, A for sinks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1111->Wrap( -1 );
	bSizer32->Add( m_staticText1111, 0, wxALL, 5 );

	m_scrolledWindow1 = new wxScrolledWindow( m_scrolledWindow2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	...
	m_staticline111 = new wxStaticLine( m_scrolledWindow2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	bSizer32->Add( m_staticline111, 0, wxEXPAND | wxALL, 5 );

	m_3DviewerSizer = new wxBoxSizer( wxVERTICAL );


	bSizer32->Add( m_3DviewerSizer, 1, wxEXPAND, 5 );

	m_staticline11 = new wxStaticLine( m_scrolledWindow2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	...
	m_radioBox1 = new wxRadioBox( m_scrolledWindow2, wxID_ANY, wxT("wxRadioBox"), wxDefaultPosition, wxDefaultSize, m_radioBox1NChoices, m_radioBox1Choices, 1, wxRA_SPECIFY_COLS );
	m_radioBox1->SetSelection( 0 );
	m_radioBox1->Enable( false );

	bSizer3->Add( m_radioBox1, 0, wxALL, 5 );

	m_checkBox2211 = new wxCheckBox( m_scrolledWindow2, wxID_ANY, wxT("Report via stress analysis"), wxDefaultPosition, wxDefaultSize, 0 );
	m_checkBox2211->Enable( false );

	bSizer3->Add( m_checkBox2211, 0, wxALL, 5 );


	bSizer32->Add( bSizer3, 0, 0, 5 );

	m_staticText31 = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("Outputs"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	bSizer32->Add( m_staticText31, 0, wxALL, 5 );
	...
	m_mapPotential = new wxCheckBox( m_scrolledWindow2, wxID_ANY, wxT("Generate 3D map : potential drop"), wxDefaultPosition, wxDefaultSize, 0 );
	m_mapPotential->SetValue(true);
	fgSizer1->Add( m_mapPotential, 0, wxALL, 5 );

	m_mapCurrentDensity = new wxCheckBox( m_scrolledWindow2, wxID_ANY, wxT("Generate 3D map : current density"), wxDefaultPosition, wxDefaultSize, 0 );
	m_mapCurrentDensity->SetValue(true);
	fgSizer1->Add( m_mapCurrentDensity, 0, wxALL, 5 );

	m_mapPowerDensity = new wxCheckBox( m_scrolledWindow2, wxID_ANY, wxT("Generate 3D map : power density density"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer1->Add( m_mapPowerDensity, 0, wxALL, 5 );

	m_textReport = new wxCheckBox( m_scrolledWindow2, wxID_ANY, wxT("Generate text report"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText12 = new wxStaticText( m_scrolledWindow2, wxID_ANY, wxT("Select a folder for outputs:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText12->Wrap( -1 );
	bSizer41->Add( m_staticText12, 0, wxALL, 5 );

	m_dirPicker11 = new wxDirPickerCtrl( m_scrolledWindow2, wxID_ANY, wxEmptyString, wxT("Select a folder"), wxDefaultPosition, wxDefaultSize, wxDIRP_DEFAULT_STYLE );
	...
	bSizer32->Add( bSizer31, 0, wxEXPAND, 5 );

	m_scrolledWindow3 = new wxScrolledWindow( m_scrolledWindow2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL|wxVSCROLL );
	...
	bSizer10->Add( m_resultGrid, 0, wxALL, 5 );
	...
	m_scrolledWindow2->SetSizer( bSizer32 );
	m_scrolledWindow2->Layout();
	bSizer32->Fit( m_scrolledWindow2 );
	bSizer1->Add( m_scrolledWindow2, 1, wxEXPAND | wxALL, 5 );
