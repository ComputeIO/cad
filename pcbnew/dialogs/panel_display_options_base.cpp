...
PANEL_DISPLAY_OPTIONS_BASE::PANEL_DISPLAY_OPTIONS_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : RESETTABLE_PANEL( parent, id, pos, size, style, name )
{
	...
	m_checkCrossProbeAllowMultiple = new wxCheckBox( sbSizer3->GetStaticBox(), wxID_ANY, _("Allow cross-probing multiple items"), wxDefaultPosition, wxDefaultSize, 0 );
	m_checkCrossProbeAllowMultiple->SetValue(true);
	sbSizer3->Add( m_checkCrossProbeAllowMultiple, 0, wxALL, 5 );
