...
DIALOG_TEXT_PROPERTIES_BASE::DIALOG_TEXT_PROPERTIES_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	m_FontLabel->Wrap( -1 );
	m_FontLabel->SetToolTip( _("Text font") );
	...
	bMainSizer->Fit( this );
	m_menu1 = new wxMenu();
	this->Connect( wxEVT_RIGHT_DOWN, wxMouseEventHandler( DIALOG_TEXT_PROPERTIES_BASE::DIALOG_TEXT_PROPERTIES_BASEOnContextMenu ), NULL, this );
	...
	m_FontDialogButton->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_TEXT_PROPERTIES_BASE::onShowFontDialog ), NULL, this );
...
DIALOG_TEXT_PROPERTIES_BASE::~DIALOG_TEXT_PROPERTIES_BASE()
{
	...
	m_FontDialogButton->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( DIALOG_TEXT_PROPERTIES_BASE::onShowFontDialog ), NULL, this );
