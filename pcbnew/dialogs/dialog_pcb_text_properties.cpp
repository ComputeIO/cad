...
{
    Disconnect( wxEVT_CHAR_HOOK, wxKeyEventHandler( DIALOG_PCB_TEXT_PROPERTIES::OnCharHook ), NULL,
                this );
}
...
{
    DIALOG_PCB_TEXT_PROPERTIES dlg( this, aText );
    dlg.ShowQuasiModal();
}
...
void DIALOG_PCB_TEXT_PROPERTIES::OnSetFocusText( wxFocusEvent& event )
{
#ifdef __WXGTK__
