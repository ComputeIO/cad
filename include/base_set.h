...
public:
    ...
    {
        return alg::lexicographical_compare_3way( *this, other );
    }
...
// Suppress the unused function warning by defining a dummy function
[[maybe_unused]] static uint64_t suppress_unused_function_warning(const void* data, uint64_t size)
{
    return popcnt(data, size);
}
