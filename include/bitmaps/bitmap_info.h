...
const std::vector<BITMAP_INFO> g_BitmapInfo = {
    ...
    { BITMAPS::label_bidirectional, wxT( "label_bidirectional.png" ), -1, wxT( "light" ) },
    { BITMAPS::label_input, wxT( "label_input.png" ), -1, wxT( "light" ) },
    { BITMAPS::label_output, wxT( "label_output.png" ), -1, wxT( "light" ) },
    { BITMAPS::label_passive, wxT( "label_passive.png" ), -1, wxT( "light" ) },
    { BITMAPS::label_tristate, wxT( "label_tristate.png" ), -1, wxT( "light" ) },
    ...
    { BITMAPS::label_bidirectional, wxT( "label_bidirectional_dark.png" ), -1, wxT( "dark" ) },
    { BITMAPS::label_input, wxT( "label_input_dark.png" ), -1, wxT( "dark" ) },
    { BITMAPS::label_output, wxT( "label_output_dark.png" ), -1, wxT( "dark" ) },
    { BITMAPS::label_passive, wxT( "label_passive_dark.png" ), -1, wxT( "dark" ) },
    { BITMAPS::label_tristate, wxT( "label_tristate_dark.png" ), -1, wxT( "dark" ) },
