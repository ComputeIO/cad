...
const std::vector<BITMAP_INFO> g_BitmapInfo = {
    ...
    { BITMAPS::component_select_alternate_shape, wxT( "component_select_alternate_shape_24.png" ), 24, wxT( "light" ) },
    ...
    { BITMAPS::component_select_alternate_shape, wxT( "component_select_alternate_shape_dark_24.png" ), 24, wxT( "dark" ) },
