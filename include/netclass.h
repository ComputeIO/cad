...
protected:
    ...
    int         m_TrackWidthInner;      ///< track width used to route NETs in this NETCLASS
...
public:
    ...
    void    SetClearanceInner( int aClearanceInner )  { m_ClearanceInner = aClearanceInner; }

    int     GetTrackWidth() const           { return m_TrackWidth; }
    void    SetTrackWidth( int aWidth )     { m_TrackWidth = aWidth; }

    int     GetTrackWidthInner() const           { return m_TrackWidthInner; }
    void    SetTrackWidthInner( int aWidthInner )     { m_TrackWidthInner = aWidthInner; }
