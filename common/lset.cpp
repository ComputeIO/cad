...
bool LSET::Contains( PCB_LAYER_ID aLayer ) const
{
    try
    {
        return test( aLayer );
...
LSET::all_set_layers_iterator::all_set_layers_iterator( const BASE_SET& set, size_t index ) :
        BASE_SET::set_bits_iterator( set, index )
{}

LSET::all_set_layers_iterator& LSET::all_set_layers_iterator::operator++()
{
...
PCB_LAYER_ID LSET::all_set_layers_iterator::operator*() const
{
    return static_cast<PCB_LAYER_ID>( m_index );
}


LSET::all_set_layers_iterator LSET::begin() const
{
    return all_set_layers_iterator( *this, 0 );
}

LSET::all_set_layers_iterator LSET::end() const
{
    return all_set_layers_iterator( *this, size() );
}
