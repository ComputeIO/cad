...
PANEL_DATA_COLLECTION_BASE::PANEL_DATA_COLLECTION_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : RESETTABLE_PANEL( parent, id, pos, size, style, name )
{
	...
	m_stExplanation = new wxStaticText( this, wxID_ANY, _("KiCad may anonymously report crashes and special event data to developers in order to aid identifying critical bugs across the user base more effectively.\n\nIf you choose to participate, KiCad will automatically handle sending said reports when crashes or events occur. Your design files such as schematic or PCB are not uploaded or shared in this process."), wxDefaultPosition, wxDefaultSize, 0 );
